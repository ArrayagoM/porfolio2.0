...
const Home = () => {
    return (
         <div className={style.container_i}>
          ...
          <div>
          <h1 className={style.title} color="teal.500">Full Satck Web Developer</h1>
          <div>
         ...
         <Cards/>
          ...
          <Link to={'https://developer.mozilla.org/es/docs/Web/html'}>
            ...
            <Link to={'https://sequelize.org/docs/v6/advanced-association-concepts/creating-with-associations/'}>
